    ...
    <div className="min-h-screen flex flex-col justify-between relative m-0 pb-10 w-full max-w-none" style={{ backgroundImage: "url('/comic.png')"}}>
      ...
      <div className="flex justify-between pt-10">
        <div className="w-1/2 h-150 ml-7">
          <h2 className="text-2xl md:text-3xl font-bold font-[Comic_Neue]">
            Bienvenido a Stickman Sigma Chat
          </h2>
          <h3 className="text-l md:text-xl font-[Comic_Sans_MS] mt-3 ml-2">
      ...
      <div className="flex justify-end my-10 w-full">
        <div className="w-[70%] h-150 mr-7">
          <h3 className="text-l md:text-xl font-[Comic_Sans_MS] mt-3 mr-2 text-center">
      ...
      <h1 id="title" className="text-4xl md:text-5xl font-bold text-center font-[Comic_Neue] mb-10 mt-10">
